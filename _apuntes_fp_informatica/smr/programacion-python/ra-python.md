---
title: Resultados de Aprendizaje y Criterios de Evaluación – Programación en Python
ciclo: SMR
curso: 2º
...
- c) Se ha instalado y configurado el entorno de desarrollo analizando las ventajas de su uso.  
...
- c) Se han implementado bucles para resolver problemas repetitivos.  
...
- c) Se han explicado las diferencias entre listas, tuplas y conjuntos.  
- d) Se han utilizado listas para almacenar, acceder y modificar colecciones de datos.  
...
- c) Se han escrito líneas de código que permiten la lectura de fichero de textos.  
